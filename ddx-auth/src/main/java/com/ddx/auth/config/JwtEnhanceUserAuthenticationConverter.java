...
public class JwtEnhanceUserAuthenticationConverter extends DefaultUserAuthenticationConverter {
    ...
    public Authentication extractAuthentication(Map<String, ?> map) {
        if (map.containsKey(USERNAME)) {
            ...
            String nickname = (String) map.get(ConstantUtils.NICKNAME);
            String loginService = (String) map.get(ConstantUtils.LOGIN_SERVICE);
            Long userId = Long.valueOf(map.get(ConstantUtils.USER_ID).toString());
