...
public class RedissonConfig {
    ...
    public RedissonClient redissonClient() {
        ...
        redissonAddress = redisPattern.equals(RedisConstant.REDIS_PATTERN_MULTIPLE)? RedisConstant.CLUSTER_SERVER + address:
                redisPattern.equals(RedisConstant.REDIS_PATTERN_STAND_ALONE)? RedisConstant.SINGLE_SERVER + address:"";
