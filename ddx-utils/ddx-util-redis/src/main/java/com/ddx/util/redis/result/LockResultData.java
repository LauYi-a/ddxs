...
public class LockResultData<T> {
    ...
    public static  <T> LockResultData result(LockEnum resultEnum, T data) {
        return new LockResultData(resultEnum.isOk(),resultEnum.getMsg(),data);
    }

    public static  <T> LockResultData<T> result(LockEnum resultEnum, String msg) {
    ...
    public static <T> LockResultData<T> result(LockEnum resultEnum) {
