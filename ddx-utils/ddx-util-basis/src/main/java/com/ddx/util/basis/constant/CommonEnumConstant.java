...
public class CommonEnumConstant {
    ...
    public enum PromptMessage{
        ...
        INVALID_TOKEN(BasisConstant.MSG_RESPONSE_CODE_INVALID_TOKEN, BasisConstant.MSG_TYPE_ERROR,"TOKEN无效或过期"),
    ...
    public enum Dict {
        ...
        WHITELIST_TYPE_0("1","系统资源白名单", BasisConstant.WHITELIST_TYPE,0,"sys","不受角色权限控制,可直接访问"),
        WHITELIST_TYPE_1("2","接口访问时效白名单", BasisConstant.WHITELIST_TYPE,1,"sys","接口连续访问不受重放时间限制"),
